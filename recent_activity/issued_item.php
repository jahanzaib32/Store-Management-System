<?php
    ...
    $pageName = "Recently Issued Items";
    ...
    <div class="mainBody">
        ...
        <div class="col-wrapper">
            <div class="userSelection">
                ...
                <select name="user" id=""  onchange="if (this.value) window.location.href= 'issued_item.php?item='+ this.value">
        ...
        <div class="reportsArea <?php echo $setClass; ?>">
            <?php 
                $query = "SELECT issued.ID AS issued_id, items.ID AS item_id, items.name AS item_name, users.name AS user_name, issued.date, issued.qty FROM issued INNER JOIN items on issued.item_id = items.ID INNER JOIN users on users.ID = issued.user_id WHERE items.ID = " . $item_id . " ";
                $result = $conn -> query($query);
            ?>
            <div class="sector">
                <div class="sectorHeader">
